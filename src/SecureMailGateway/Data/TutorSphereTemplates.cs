...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — Contrat enseignant à signer",
            SubjectTemplate: "Contrat {{ContractNumber}} à signer — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">Votre contrat de collaboration</h2>
                <p>Bonjour {{FirstName}},</p>
                <p>Le groupe <strong>{{GroupName}}</strong> vous a envoyé le contrat électronique <strong>{{ContractNumber}}</strong>. Lisez chaque section, approuvez-les, puis signez. Le lien est valable jusqu’au {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">Ouvrir et signer le contrat</a></p>
                <p style="font-size:13px;color:#888;">Ce lien est personnel et expire après 14 jours. Ne le transmettez pas.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          Cet e-mail a été envoyé par TutorSphere. Ne répondez pas directement à ce message.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "Bonjour {{FirstName}}, le groupe {{GroupName}} vous a envoyé le contrat {{ContractNumber}} à signer avant {{ExpiresAt}} : {{SignUrl}}",
            Language: "fr",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — Teacher contract to sign",
            SubjectTemplate: "Contract {{ContractNumber}} to sign — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">Your collaboration contract</h2>
                <p>Hello {{FirstName}},</p>
                <p>The group <strong>{{GroupName}}</strong> has sent you electronic contract <strong>{{ContractNumber}}</strong>. Read each section, approve them, then sign. The link is valid until {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">Open and sign the contract</a></p>
                <p style="font-size:13px;color:#888;">This link is personal and expires after 14 days. Do not share it.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          This email was sent by TutorSphere. Please do not reply directly to this message.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "Hello {{FirstName}}, the group {{GroupName}} sent you contract {{ContractNumber}} to sign before {{ExpiresAt}}: {{SignUrl}}",
            Language: "en",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — Contrato docente por firmar",
            SubjectTemplate: "Contrato {{ContractNumber}} por firmar — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">Su contrato de colaboración</h2>
                <p>Hola {{FirstName}},</p>
                <p>El grupo <strong>{{GroupName}}</strong> le ha enviado el contrato electrónico <strong>{{ContractNumber}}</strong>. Lea cada sección, apruébelas y firme. El enlace es válido hasta {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">Abrir y firmar el contrato</a></p>
                <p style="font-size:13px;color:#888;">Este enlace es personal y caduca a los 14 días. No lo comparta.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          Este correo fue enviado por TutorSphere. No responda directamente a este mensaje.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "Hola {{FirstName}}, el grupo {{GroupName}} le envió el contrato {{ContractNumber}} para firmar antes del {{ExpiresAt}}: {{SignUrl}}",
            Language: "es",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — Lehrervertrag zur Unterschrift",
            SubjectTemplate: "Vertrag {{ContractNumber}} zur Unterschrift — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">Ihr Kooperationsvertrag</h2>
                <p>Hallo {{FirstName}},</p>
                <p>Die Gruppe <strong>{{GroupName}}</strong> hat Ihnen den elektronischen Vertrag <strong>{{ContractNumber}}</strong> gesendet. Lesen Sie jeden Abschnitt, bestätigen Sie ihn und unterzeichnen Sie. Der Link gilt bis {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">Vertrag öffnen und unterzeichnen</a></p>
                <p style="font-size:13px;color:#888;">Dieser Link ist persönlich und läuft nach 14 Tagen ab. Geben Sie ihn nicht weiter.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          Diese E-Mail wurde von TutorSphere gesendet. Bitte antworten Sie nicht direkt auf diese Nachricht.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "Hallo {{FirstName}}, die Gruppe {{GroupName}} hat Ihnen den Vertrag {{ContractNumber}} zur Unterschrift bis {{ExpiresAt}} gesendet: {{SignUrl}}",
            Language: "de",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — Contrato de professor para assinar",
            SubjectTemplate: "Contrato {{ContractNumber}} para assinar — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">O seu contrato de colaboração</h2>
                <p>Olá {{FirstName}},</p>
                <p>O grupo <strong>{{GroupName}}</strong> enviou-lhe o contrato eletrónico <strong>{{ContractNumber}}</strong>. Leia cada secção, aprove-as e assine. A ligação é válida até {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">Abrir e assinar o contrato</a></p>
                <p style="font-size:13px;color:#888;">Esta ligação é pessoal e expira após 14 dias. Não a partilhe.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          Este e-mail foi enviado pelo TutorSphere. Não responda diretamente a esta mensagem.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "Olá {{FirstName}}, o grupo {{GroupName}} enviou-lhe o contrato {{ContractNumber}} para assinar até {{ExpiresAt}}: {{SignUrl}}",
            Language: "pt",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — 待签署的教师合同",
            SubjectTemplate: "待签署合同 {{ContractNumber}} — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">您的合作合同</h2>
                <p>{{FirstName}}，您好，</p>
                <p>专家组 <strong>{{GroupName}}</strong> 已向您发送电子合同 <strong>{{ContractNumber}}</strong>。请逐节阅读并确认，然后签署。链接有效期至 {{ExpiresAt}}。</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">打开并签署合同</a></p>
                <p style="font-size:13px;color:#888;">此链接仅供本人使用，14 天后失效。请勿转发。</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          此邮件由 TutorSphere 发送。请勿直接回复此消息。<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "{{FirstName}}，您好，专家组 {{GroupName}} 已发送合同 {{ContractNumber}}，请在 {{ExpiresAt}} 前签署：{{SignUrl}}",
            Language: "zh-Hans",
            SeedRevision: 14),
...
""",
        ...
        new(
            TemplateCode: "TEACHER_CONTRACT_SIGN",
            Name: "TutorSphere — عقد المعلم للتوقيع",
            SubjectTemplate: "العقد {{ContractNumber}} للتوقيع — {{GroupName}}",
            HtmlBody: """
<div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#f5f3ff;padding:32px 16px;min-height:100vh;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(88,49,224,0.08);">
            <div style="background:#5831E0;padding:20px 24px;border-radius:8px 8px 0 0;">
          <p style="margin:0;font-size:20px;font-weight:bold;color:#ffffff;letter-spacing:-0.5px;">TutorSphere</p>
            ...
            <div style="padding:32px 32px 24px;">
              <h2 style="color:#5831E0;margin:0 0 12px;">عقد التعاون الخاص بك</h2>
                <p>مرحبًا {{FirstName}}،</p>
                <p>أرسلت مجموعة <strong>{{GroupName}}</strong> إليك العقد الإلكتروني <strong>{{ContractNumber}}</strong>. اقرأ كل قسم ووافق عليه ثم وقّع. الرابط صالح حتى {{ExpiresAt}}.</p>
                <p style="text-align:center;margin:28px 0;"><a href="{{SignUrl}}" style="background:#5831E0;color:#ffffff;padding:12px 28px;text-decoration:none;border-radius:6px;font-weight:600;font-size:15px;display:inline-block;">فتح العقد وتوقيعه</a></p>
                <p style="font-size:13px;color:#888;">هذا الرابط شخصي وينتهي بعد 14 يومًا. لا تشاركه.</p>
              <hr style="border:none;border-top:1px solid #ede9fb;margin:32px 0 16px;" />
        <p style="font-size:12px;color:#888;margin:0;">
          تم إرسال هذا البريد بواسطة TutorSphere. يُرجى عدم الرد مباشرة على هذه الرسالة.<br/>© 2026 TutorSphere — <a href="https://tutorsphere.gisebs.com" style="color:#5831E0;text-decoration:none;">tutorsphere.gisebs.com</a>
        </p>
        ...
        <!-- tutorsphere-seed:14 -->
""",
            TextBody: "مرحبًا {{FirstName}}، أرسلت مجموعة {{GroupName}} إليك العقد {{ContractNumber}} للتوقيع قبل {{ExpiresAt}}: {{SignUrl}}",
            Language: "ar",
            SeedRevision: 14)
    ];
}
