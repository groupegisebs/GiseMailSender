    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailCodeSequences", x => x.Year);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestSummary = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ResponseSummary = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiCallLogs_ClientApplications_ClientApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenPrefix = table.Column<string>(type: "character varying(12)", maxLength: 12, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiTokens_ClientApplications_ClientApplicationId",
                        column: x => x.ClientApplicationId,
                        principalTable: "ClientApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_ClientApplications_ClientApplicationId",
                        column: x => x.ClientApplicationId,
                        principalTable: "ClientApplications",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MailCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ClientApplicationId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailMessages_ClientApplications_ClientApplicationId",
                        column: x => x.ClientApplicationId,
                        principalTable: "ClientApplications",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailSendLogs_EmailMessages_EmailMessageId",
                        column: x => x.EmailMessageId,
                        principalTable: "EmailMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiCallLogs_ClientApplicationId",
                table: "ApiCallLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiTokens_ClientApplicationId",
                table: "ApiTokens",
                column: "ClientApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ClientApplicationId",
                table: "AuditLogs",
                column: "ClientApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientApplications_ClientCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailMessages_ClientApplicationId",
                table: "EmailMessages",
                column: "ClientApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailMessages_MailCode",
                table: "EmailMessages",
                column: "MailCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailSendLogs_EmailMessageId",
                table: "EmailSendLogs",
                column: "EmailMessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailTemplateVersions_EmailTemplateId_Version",
                table: "EmailTemplateVersions",
                columns: new[] { "EmailTemplateId", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SmtpConfigurations_IsDefault",
